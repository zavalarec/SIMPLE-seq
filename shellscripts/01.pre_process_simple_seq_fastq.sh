...
## p="path-to-cell-id-reference"  # reference file is in "Cell_BC_reference/" of github directory,  "SIMPLE_Brain_ID_ref" for brain.
## simpleconv combine3 ${s} 

### version for bowtie will change for use of this step
zcat ${s}_combined.fq.gz | bowtie ${p} - --norc -m 1 -v 1 -S ${s}_BC.sam ## for bowtie 1.x
# zcat ${s}_combined.fq.gz | bowtie -x ${p} - --norc -m 1 -v 1 -S ${s}_BC.sam ## for bowtie 0.x
